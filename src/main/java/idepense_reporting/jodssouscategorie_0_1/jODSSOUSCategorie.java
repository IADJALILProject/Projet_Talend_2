...
package idepense_reporting.jodssouscategorie_0_1;
...
/**
 * Job: jODSSOUSCategorie Purpose: <br>
 * Description:  <br>
...
globalMap.put("nomFichier", "IDEP_SOUS_CATEGORIE.csv");
globalMap.put("nomFlux", "SOUS_CATEGORIE");
...
public static class insertDuplicateStruct implements routines.system.IPersistableRow<insertDuplicateStruct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jODSSOUSCategorie = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie.length) {
				if(length < 1024 && commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie.length == 0) {
   					commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie = new byte[1024];
				} else {
   					commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jODSSOUSCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IDEPENSE_REPORTING_jODSSOUSCategorie) {
...
public static class insertNewcategorieStruct implements routines.system.IPersistableRow<insertNewcategorieStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.LB_SOUS_CATEGORIE == null) ? 0 : this.LB_SOUS_CATEGORIE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final insertNewcategorieStruct other = (insertNewcategorieStruct) obj;
						...
						if (this.LB_SOUS_CATEGORIE == null) {
							if (other.LB_SOUS_CATEGORIE != null)
								return false;
						
						} else if (!this.LB_SOUS_CATEGORIE.equals(other.LB_SOUS_CATEGORIE))
    ...
    public int compareTo(insertNewcategorieStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.LB_SOUS_CATEGORIE, other.LB_SOUS_CATEGORIE);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tDBOutput_3=0;
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"LB_SOUS_CATEGORIE\",\"LB_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?)";
...
Var.varNumLigne = Numeric.sequence("s2",1,1) ;// ###############################
        // ###############################
        // # Output tables
...
InsertNumLigne_tmp.NUM_LIGNE = Numeric.sequence("s2",1,1) ;
...
InsertRejet_tmp.NUM_LIGNE_REJET = Numeric.sequence("s2",1,1) ;
InsertRejet_tmp.LB_LIGNE_REJET = row2.LB_CATEGORIE +  row2.LB_SOUS_CATEGORIE ;
...
row3 = null;			row4 = null;			
if(InsertNumLigne.LB_SOUS_CATEGORIE == null){
	finder_tUniqRow_1.LB_SOUS_CATEGORIE = null;
}else{
	finder_tUniqRow_1.LB_SOUS_CATEGORIE = InsertNumLigne.LB_SOUS_CATEGORIE.toLowerCase();
}	
...
if(InsertNumLigne.LB_SOUS_CATEGORIE == null){
	new_tUniqRow_1.LB_SOUS_CATEGORIE = null;
}else{
	new_tUniqRow_1.LB_SOUS_CATEGORIE = InsertNumLigne.LB_SOUS_CATEGORIE.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row4 == null){ 
	
	row4 = new row4Struct();
}row4.LB_CATEGORIE = InsertNumLigne.LB_CATEGORIE;			row4.LB_SOUS_CATEGORIE = InsertNumLigne.LB_SOUS_CATEGORIE;			row4.NUM_LIGNE = InsertNumLigne.NUM_LIGNE;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row3 == null){ 
	
	row3 = new row3Struct();
}				row3.LB_CATEGORIE = InsertNumLigne.LB_CATEGORIE;			row3.LB_SOUS_CATEGORIE = InsertNumLigne.LB_SOUS_CATEGORIE;			row3.NUM_LIGNE = InsertNumLigne.NUM_LIGNE;			
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row5HashKey.LB_SOUS_CATEGORIE = row4.LB_SOUS_CATEGORIE ;
								  ...
								  if(!tHash_Lookup_row5.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.LB_SOUS_CATEGORIE = '" + row5HashKey.LB_SOUS_CATEGORIE + "'");
								} // G 071
...
} else {pstmt_tDBOutput_3.setString(1, insertNewcategorie.LB_SOUS_CATEGORIE);
}

                    if(insertNewcategorie.LB_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertNewcategorie.LB_CATEGORIE);
}

                    if(insertNewcategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, insertNewcategorie.LB_NOM_FICHIER);
}

                    if(insertNewcategorie.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(4, new java.sql.Timestamp(insertNewcategorie.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_3.setString(5, insertNewcategorie.LB_JOB_NAME);
}
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
        	...
        	row5.LB_SOUS_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row5.LB_CATEGORIE = null;
							} else {
	                         		
        	row5.LB_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
        	...
        	row5.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jODSSOUSCategorie.class.getClassLoader().getResourceAsStream("idepense_reporting/jodssouscategorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("ServerName")) {
            ...
            }if (parentContextMap.containsKey("aditionnalParam")) {
...
/************************************************************************************************
 *     226166 characters generated by Talend Open Studio for Data Integration 
 *     on the 18 octobre 2024 à 20:24:57 CEST
 ************************************************************************************************/