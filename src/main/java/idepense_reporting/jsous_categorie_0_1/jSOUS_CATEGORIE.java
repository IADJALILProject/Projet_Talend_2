...
package idepense_reporting.jsous_categorie_0_1;
...
/**
 * Job: jSOUS_CATEGORIE Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jSOUS_CATEGORIE implements TalendJob {
...
public String getFieldSeparator(){
	...
	private final String jobName = "jSOUS_CATEGORIE";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jSOUS_CATEGORIE.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jSOUS_CATEGORIE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jSOUS_CATEGORIE = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE.length) {
				if(length < 1024 && commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE.length == 0) {
   					commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE = new byte[1024];
				} else {
   					commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jSOUS_CATEGORIE, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IDEPENSE_REPORTING_jSOUS_CATEGORIE) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.projectFolder + context.dataFolder  + "/IDEP_SOUS_CATEGORIE.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"LB_SOUS_CATEGORIE","LB_CATEGORIE",});        
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:BQAZFAwj1EGykh04pl7tiGRzV3WHMkLV7xUgGg==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "SOUS_CATEGORIE_DEPENSE", false));
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(row2.LB_SOUS_CATEGORIE != null) {
                        sb_tFileOutputDelimited_1.append(
                            row2.LB_SOUS_CATEGORIE
                        );
                            }
 ...
 */
    ...
    public static void main(String[] args){
        final jSOUS_CATEGORIE jSOUS_CATEGORIEClass = new jSOUS_CATEGORIE();

        int exitCode = jSOUS_CATEGORIEClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jSOUS_CATEGORIE.class.getClassLoader().getResourceAsStream("idepense_reporting/jsous_categorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jSOUS_CATEGORIE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jSOUS_CATEGORIE");
        }
...
/************************************************************************************************
 *     68341 characters generated by Talend Open Studio for Data Integration 
