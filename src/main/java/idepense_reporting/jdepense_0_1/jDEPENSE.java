...
package idepense_reporting.jdepense_0_1;
...
/**
 * Job: jDEPENSE Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jDEPENSE implements TalendJob {
...
public String getFieldSeparator(){
	...
	private final String jobName = "jDEPENSE";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jDEPENSE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jDEPENSE = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jDEPENSE = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IDEPENSE_REPORTING_jDEPENSE.length) {
				if(length < 1024 && commonByteArray_IDEPENSE_REPORTING_jDEPENSE.length == 0) {
   					commonByteArray_IDEPENSE_REPORTING_jDEPENSE = new byte[1024];
				} else {
   					commonByteArray_IDEPENSE_REPORTING_jDEPENSE = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IDEPENSE_REPORTING_jDEPENSE, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jDEPENSE, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IDEPENSE_REPORTING_jDEPENSE, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jDEPENSE, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IDEPENSE_REPORTING_jDEPENSE) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.projectFolder + context.dataFolder+"/IDEP_CATEGORIE.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"LB_CATEGORIE",});        
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Jn6doZz99+bhnfZHoW8LnLRDA30woy4BGM3d1Q==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "CATEGORIE_DEPENSE", false));
 ...
 */
    ...
    public static void main(String[] args){
        final jDEPENSE jDEPENSEClass = new jDEPENSE();

        int exitCode = jDEPENSEClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jDEPENSE.class.getClassLoader().getResourceAsStream("idepense_reporting/jdepense_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jDEPENSE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jDEPENSE");
        }
...
/************************************************************************************************
 *     66144 characters generated by Talend Open Studio for Data Integration 
