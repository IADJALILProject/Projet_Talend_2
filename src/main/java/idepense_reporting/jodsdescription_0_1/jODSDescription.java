...
package idepense_reporting.jodsdescription_0_1;
...
/**
 * Job: jODSDescription Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jODSDescription implements TalendJob {
...
public String getFieldSeparator(){
	...
	private final String jobName = "jODSDescription";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jODSDescription.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jODSDescription.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class InsertDescriptionStruct implements routines.system.IPersistableRow<InsertDescriptionStruct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jODSDescription = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jODSDescription = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.LB_DESCRIPTION_DEPENSE == null) ? 0 : this.LB_DESCRIPTION_DEPENSE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final InsertDescriptionStruct other = (InsertDescriptionStruct) obj;
		
						if (this.LB_DESCRIPTION_DEPENSE == null) {
							if (other.LB_DESCRIPTION_DEPENSE != null)
								return false;
						
						} else if (!this.LB_DESCRIPTION_DEPENSE.equals(other.LB_DESCRIPTION_DEPENSE))
	...
	public void copyDataTo(InsertDescriptionStruct other) {
	...
	public void copyKeysDataTo(InsertDescriptionStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IDEPENSE_REPORTING_jODSDescription.length) {
				if(length < 1024 && commonByteArray_IDEPENSE_REPORTING_jODSDescription.length == 0) {
   					commonByteArray_IDEPENSE_REPORTING_jODSDescription = new byte[1024];
				} else {
   					commonByteArray_IDEPENSE_REPORTING_jODSDescription = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IDEPENSE_REPORTING_jODSDescription, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jODSDescription, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IDEPENSE_REPORTING_jODSDescription, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jODSDescription, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IDEPENSE_REPORTING_jODSDescription) {
     ...
     * Compare keys
     */
    public int compareTo(InsertDescriptionStruct other) {

		int returnValue = -1;
		
						returnValue = checkNullsAndCompare(this.LB_DESCRIPTION_DEPENSE, other.LB_DESCRIPTION_DEPENSE);
						if(returnValue != 0) {
							return returnValue;
						}
...
InsertDescriptionStruct InsertDescription = new InsertDescriptionStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"InsertDescription");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ODS_DESCRIPTION");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ODS_DESCRIPTION");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"LB_DESCRIPTION_DEPENSE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?)";
...
InsertDescriptionStruct InsertDescription_tmp = new InsertDescriptionStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
        	...
        	row1.LB_DESCRIPTION_DEPENSE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row1.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.LB_DESCRIPTION_DEPENSE = row1.LB_DESCRIPTION_DEPENSE ;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.LB_DESCRIPTION_DEPENSE = '" + row2HashKey.LB_DESCRIPTION_DEPENSE + "'");
								} // G 071
...
// # Output reject table : 'InsertDescription'
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
InsertDescription_tmp.LB_DESCRIPTION_DEPENSE = row1.LB_DESCRIPTION_DEPENSE ;
InsertDescription_tmp.LB_NOM_FICHIER = row1.LB_NOM_FICHIER ;
InsertDescription_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
InsertDescription_tmp.LB_JOB_NAME = jobName;
InsertDescription = InsertDescription_tmp;
 ...
 */
// Start of branch "InsertDescription"
if(InsertDescription != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(InsertDescription.LB_DESCRIPTION_DEPENSE == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, InsertDescription.LB_DESCRIPTION_DEPENSE);
}

                    if(InsertDescription.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, InsertDescription.LB_NOM_FICHIER);
}

                    if(InsertDescription.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(InsertDescription.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(InsertDescription.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, InsertDescription.LB_JOB_NAME);
}
...
} // End of branch "InsertDescription"
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"InsertDescription");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(InsertDescription)
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "SELECT \n  \""+context.schema_ods+"\".\"ODS_DESCRIPTION\".\"LB_DESCRIPTION_DEPENSE\", \n  \""+context.schema_ods+"\".\"ODS_DESCRIPTION\".\"LB_NOM_FICHIER\", \n  \""+context.schema_ods+"\".\"ODS_DESCRIPTION\".\"DT_INSERTION\", \n  \""+context.schema_ods+"\".\"ODS_DESCRIPTION\".\"LB_JOB_NAME\"\nFROM \""+context.schema_ods+"\".\"ODS_DESCRIPTION\"";
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row2.LB_DESCRIPTION_DEPENSE = null;
							} else {
	                         		
        	row2.LB_DESCRIPTION_DEPENSE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row2.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row2.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row2.DT_INSERTION = null;
							} else {
										
			row2.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 3);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row2.LB_JOB_NAME = null;
							} else {
	                         		
        	row2.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.LB_DESCRIPTION_DEPENSE = row2.LB_DESCRIPTION_DEPENSE;
 ...
 */
    ...
    public static void main(String[] args){
        final jODSDescription jODSDescriptionClass = new jODSDescription();

        int exitCode = jODSDescriptionClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jODSDescription.class.getClassLoader().getResourceAsStream("idepense_reporting/jodsdescription_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jODSDescription.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jODSDescription");
        }
...
/************************************************************************************************
 *     122852 characters generated by Talend Open Studio for Data Integration 
 *     on the 18 octobre 2024 à 20:24:59 CEST
 ************************************************************************************************/