...
package idepense_reporting.jodscategorie_0_1;
...
globalMap.put("nomFichier", "IDEP_CATEGORIE.csv");
globalMap.put("nomFlux", "CATEGORIE");
...
public static class insertDuplicateStruct implements routines.system.IPersistableRow<insertDuplicateStruct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jODSCategorie = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jODSCategorie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IDEPENSE_REPORTING_jODSCategorie.length) {
				if(length < 1024 && commonByteArray_IDEPENSE_REPORTING_jODSCategorie.length == 0) {
   					commonByteArray_IDEPENSE_REPORTING_jODSCategorie = new byte[1024];
				} else {
   					commonByteArray_IDEPENSE_REPORTING_jODSCategorie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IDEPENSE_REPORTING_jODSCategorie, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jODSCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IDEPENSE_REPORTING_jODSCategorie, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jODSCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IDEPENSE_REPORTING_jODSCategorie) {
...
public static class insertNewcategorieStruct implements routines.system.IPersistableRow<insertNewcategorieStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.LB_CATEGORIE == null) ? 0 : this.LB_CATEGORIE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final insertNewcategorieStruct other = (insertNewcategorieStruct) obj;
						...
						if (this.LB_CATEGORIE == null) {
							if (other.LB_CATEGORIE != null)
								return false;
						
						} else if (!this.LB_CATEGORIE.equals(other.LB_CATEGORIE))
    ...
    public int compareTo(insertNewcategorieStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.LB_CATEGORIE, other.LB_CATEGORIE);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tDBOutput_3=0;
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"LB_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?)";
...
Var.varNumLigne = Numeric.sequence("s1",1,1) ;// ###############################
        // ###############################
        // # Output tables
...
!StringHandling.TRIM(row2.LB_CATEGORIE).isEmpty()

 ) {
rejected_tMap_1 = false;
InsertNumLigne_tmp.LB_CATEGORIE = row2.LB_CATEGORIE  ;
InsertNumLigne_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1) ;
InsertNumLigne = InsertNumLigne_tmp;
} // closing filter/reject
// ###### START REJECTS ##### 

// # Output reject table : 'InsertRejet'
// # Filter conditions 
if( rejected_tMap_1 ) {
InsertRejet_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("repoFichier"));
InsertRejet_tmp.LB_NOM_FICHIER = ((String)globalMap.get("nomFichier"));
InsertRejet_tmp.NUM_LIGNE_REJET = Numeric.sequence("s1",1,1) ;
InsertRejet_tmp.LB_LIGNE_REJET = row2.LB_CATEGORIE ;
InsertRejet_tmp.LB_MESSAGE_REJET = "Valleurs nulles pour la colonne categorie";
InsertRejet_tmp.LB_NOM_FLUX = ((String)globalMap.get("nomFlux"));
InsertRejet_tmp.DT_REJET = TalendDate.getCurrentDate() ;
InsertRejet_tmp.LB_JOB_NAME = jobName;
InsertRejet = InsertRejet_tmp;
} // closing filter/reject
// ###############################
...
row3 = null;			row4 = null;			
if(InsertNumLigne.LB_CATEGORIE == null){
	finder_tUniqRow_1.LB_CATEGORIE = null;
}else{
	finder_tUniqRow_1.LB_CATEGORIE = InsertNumLigne.LB_CATEGORIE.toLowerCase();
}	
...
if(InsertNumLigne.LB_CATEGORIE == null){
	new_tUniqRow_1.LB_CATEGORIE = null;
}else{
	new_tUniqRow_1.LB_CATEGORIE = InsertNumLigne.LB_CATEGORIE.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row4 == null){ 
	
	row4 = new row4Struct();
}row4.LB_CATEGORIE = InsertNumLigne.LB_CATEGORIE;			row4.NUM_LIGNE = InsertNumLigne.NUM_LIGNE;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row3 == null){ 
	
	row3 = new row3Struct();
}				row3.LB_CATEGORIE = InsertNumLigne.LB_CATEGORIE;			row3.NUM_LIGNE = InsertNumLigne.NUM_LIGNE;			
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row5HashKey.LB_CATEGORIE = row4.LB_CATEGORIE ;
								  ...
								  if(!tHash_Lookup_row5.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.LB_CATEGORIE = '" + row5HashKey.LB_CATEGORIE + "'");
								} // G 071
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_3 ) {
insertNewcategorie_tmp.LB_CATEGORIE = row4.LB_CATEGORIE ;
...
if(insertNewcategorie != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(insertNewcategorie.LB_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, insertNewcategorie.LB_CATEGORIE);
}

                    if(insertNewcategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertNewcategorie.LB_NOM_FICHIER);
}

                    if(insertNewcategorie.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(insertNewcategorie.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_3.setString(4, insertNewcategorie.LB_JOB_NAME);
}
...
insertDuplicate_tmp.LB_LIGNE_REJET = row3.LB_CATEGORIE ;
...
} else {pstmtUpdate_tDBOutput_1.setString(1, InsertRejet.LB_MESSAGE_REJET);
}

                        if(InsertRejet.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, InsertRejet.LB_NOM_FLUX);
}

                        if(InsertRejet.DT_REJET != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(InsertRejet.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_1.setString(4, InsertRejet.LB_JOB_NAME);
}

                        if(InsertRejet.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, InsertRejet.LB_CHEMIN_FICHIER);
}

                        if(InsertRejet.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, InsertRejet.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1, InsertRejet.NUM_LIGNE_REJET);

                        if(InsertRejet.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1, InsertRejet.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, InsertRejet.LB_CHEMIN_FICHIER);
}

                        if(InsertRejet.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, InsertRejet.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_1.setInt(3, InsertRejet.NUM_LIGNE_REJET);

                        if(InsertRejet.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, InsertRejet.LB_LIGNE_REJET);
}

                        if(InsertRejet.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, InsertRejet.LB_MESSAGE_REJET);
}

                        if(InsertRejet.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, InsertRejet.LB_NOM_FLUX);
}

                        if(InsertRejet.DT_REJET != null) {
pstmtInsert_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(InsertRejet.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(8, InsertRejet.LB_JOB_NAME);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// linked node: tMap_3 - inputs:(row4,row5) outputs:(insertNewcategorie)
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row5.LB_CATEGORIE = null;
							} else {
	                         		
        	row5.LB_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row5.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row5.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row5.DT_INSERTION = null;
							} else {
										
			row5.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row5.LB_JOB_NAME = null;
							} else {
	                         		
        	row5.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
				...
				row5_HashRow.LB_CATEGORIE = row5.LB_CATEGORIE;
...
java.io.File file_tFileExist_2 = new java.io.File(((String)globalMap.get("repoFichier")) + "/" + ((String)globalMap.get("nomFichier")));
...
globalMap.put("tFileExist_2_FILENAME",((String)globalMap.get("repoFichier")) + "/" + ((String)globalMap.get("nomFichier")));
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jODSCategorie.class.getClassLoader().getResourceAsStream("idepense_reporting/jodscategorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     230684 characters generated by Talend Open Studio for Data Integration 
 *     on the 18 octobre 2024 à 20:24:55 CEST
 ************************************************************************************************/