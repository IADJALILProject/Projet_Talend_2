...
package idepense_reporting.jodsdepensee_0_1;
...
/**
 * Job: jODSDepensee Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jODSDepensee implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(aditionnalParam != null){
				
					this.setProperty("aditionnalParam", aditionnalParam.toString());
...
public String aditionnalParam;
public String getAditionnalParam(){
	return this.aditionnalParam;
}
...
public String getFieldSeparator(){
	...
	private final String jobName = "jODSDepensee";
	private final String projectName = "IDEPENSE_REPORTING";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jODSDepensee.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
		...
		int tos_count_tDBConnection_1 = 0;
            ...
            String dbProperties_tDBConnection_1 = context.aditionnalParam;
...
globalMap.put("nomFichier", "DEPENSE.csv");
globalMap.put("nomFlux", "DEPENSE");
globalMap.put("repoFichier", context.projectFolder + context.dataFolder);
...
java.io.File file_tFileExist_1 = new java.io.File(((String)globalMap.get("repoFichier")) + "/" + ((String)globalMap.get("nomFichier")));
...
globalMap.put("tFileExist_1_FILENAME",((String)globalMap.get("repoFichier")) + "/" + ((String)globalMap.get("nomFichier")));
...
public static class insertDuplicateStruct implements routines.system.IPersistableRow<insertDuplicateStruct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jODSDepensee = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jODSDepensee = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IDEPENSE_REPORTING_jODSDepensee.length) {
				if(length < 1024 && commonByteArray_IDEPENSE_REPORTING_jODSDepensee.length == 0) {
   					commonByteArray_IDEPENSE_REPORTING_jODSDepensee = new byte[1024];
				} else {
   					commonByteArray_IDEPENSE_REPORTING_jODSDepensee = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IDEPENSE_REPORTING_jODSDepensee, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jODSDepensee, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IDEPENSE_REPORTING_jODSDepensee, 0, length);
			strReturn = new String(commonByteArray_IDEPENSE_REPORTING_jODSDepensee, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IDEPENSE_REPORTING_jODSDepensee) {
...
public static class insertNewcategorieStruct implements routines.system.IPersistableRow<insertNewcategorieStruct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jODSDepensee = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jODSDepensee = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
    ...
    public String loopKey;
			    ...
			    public String NUM_DEPENSE;

				public String getNUM_DEPENSE () {
					return this.NUM_DEPENSE;
				}
				
			    public java.util.Date DT_DEPENSE;

				public java.util.Date getDT_DEPENSE () {
					return this.DT_DEPENSE;
				}
				
			    public String LB_DESCRIPTION_DEPENSE;

				public String getLB_DESCRIPTION_DEPENSE () {
					return this.LB_DESCRIPTION_DEPENSE;
				}
			    ...
			    public float MT_DEPENSE;

				public float getMT_DEPENSE () {
					return this.MT_DEPENSE;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.NUM_DEPENSE == null) ? 0 : this.NUM_DEPENSE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insertNewcategorieStruct other = (insertNewcategorieStruct) obj;
		
						if (this.NUM_DEPENSE == null) {
							if (other.NUM_DEPENSE != null)
								return false;
						
						} else if (!this.NUM_DEPENSE.equals(other.NUM_DEPENSE))
	...
	public void copyDataTo(insertNewcategorieStruct other) {

		other.NUM_DEPENSE = this.NUM_DEPENSE;
	            other.DT_DEPENSE = this.DT_DEPENSE;
	            other.LB_DESCRIPTION_DEPENSE = this.LB_DESCRIPTION_DEPENSE;
	            other.LB_SOUS_CATEGORIE = this.LB_SOUS_CATEGORIE;
	            other.MT_DEPENSE = this.MT_DEPENSE;
	            other.LB_NOM_FICHIER = this.LB_NOM_FICHIER;
	...
	public void copyKeysDataTo(insertNewcategorieStruct other) {
		...
		synchronized(commonByteArrayLock_IDEPENSE_REPORTING_jODSDepensee) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.NUM_DEPENSE = readString(dis);
					
					this.DT_DEPENSE = readDate(dis);
					
					this.LB_DESCRIPTION_DEPENSE = readString(dis);
					
					this.LB_SOUS_CATEGORIE = readString(dis);
					
			        this.MT_DEPENSE = dis.readFloat();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.NUM_DEPENSE,dos);
					
					// java.util.Date
				
						writeDate(this.DT_DEPENSE,dos);
					
					// String
				
						writeString(this.LB_DESCRIPTION_DEPENSE,dos);
					...
					// float
		            	...
		            	dos.writeFloat(this.MT_DEPENSE);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("NUM_DEPENSE="+NUM_DEPENSE);
		sb.append(",DT_DEPENSE="+String.valueOf(DT_DEPENSE));
		sb.append(",LB_DESCRIPTION_DEPENSE="+LB_DESCRIPTION_DEPENSE);
		sb.append(",LB_SOUS_CATEGORIE="+LB_SOUS_CATEGORIE);
		sb.append(",MT_DEPENSE="+String.valueOf(MT_DEPENSE));
		sb.append(",LB_NOM_FICHIER="+LB_NOM_FICHIER);
     ...
     * Compare keys
     */
    public int compareTo(insertNewcategorieStruct other) {

		int returnValue = -1;
		
						returnValue = checkNullsAndCompare(this.NUM_DEPENSE, other.NUM_DEPENSE);
						if(returnValue != 0) {
							return returnValue;
						}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.LB_SOUS_CATEGORIE = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.MT_DEPENSE = null;
           				} else {
           			    	this.MT_DEPENSE = dis.readFloat();
           				}
					
			        this.NUM_LIGNE = dis.readInt();
...
public static class InsertNumLigneStruct implements routines.system.IPersistableRow<InsertNumLigneStruct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jODSDepensee = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jODSDepensee = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(InsertNumLigneStruct other) {
...
public static class InsertRejetStruct implements routines.system.IPersistableRow<InsertRejetStruct> {
    final static byte[] commonByteArrayLock_IDEPENSE_REPORTING_jODSDepensee = new byte[0];
    static byte[] commonByteArray_IDEPENSE_REPORTING_jODSDepensee = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final InsertRejetStruct other = (InsertRejetStruct) obj;
	...
	public void copyDataTo(InsertRejetStruct other) {
	...
	public void copyKeysDataTo(InsertRejetStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(InsertRejetStruct other) {
...
InsertNumLigneStruct InsertNumLigne = new InsertNumLigneStruct();
row4Struct row4 = new row4Struct();
insertNewcategorieStruct insertNewcategorie = new insertNewcategorieStruct();
row3Struct row3 = new row3Struct();
insertDuplicateStruct insertDuplicate = new insertDuplicateStruct();
InsertRejetStruct InsertRejet = new InsertRejetStruct();
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertNewcategorie");
					}
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("ODS_DEPENSE");
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("ODS_DEPENSE");
}
...
int count_tDBOutput_3=0;
            ...
            try (java.sql.Statement stmtCreate_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
                stmtCreate_tDBOutput_3.execute("CREATE TABLE \"" + tableName_tDBOutput_3 + "\"(\"NUM_DEPENSE\" VARCHAR(50)   not null ,\"DT_DEPENSE\" TIMESTAMP(29)   not null ,\"LB_DESCRIPTION_DEPENSE\" VARCHAR(255)   not null ,\"LB_SOUS_CATEGORIE\" VARCHAR(50)   not null ,\"MT_DEPENSE\" FLOAT4  not null ,\"LB_NOM_FICHIER\" VARCHAR(100)   not null ,\"DT_INSERTION\" TIMESTAMP(29)   not null ,\"LB_JOB_NAME\" VARCHAR(100)   not null ,primary key(\"NUM_DEPENSE\"))");
            }
	    java.sql.PreparedStatement pstmt_tDBOutput_3 = conn_tDBOutput_3.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_3 + "\" WHERE \"NUM_DEPENSE\" = ?");
	    resourceMap.put("pstmt_tDBOutput_3", pstmt_tDBOutput_3);
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"NUM_DEPENSE\",\"DT_DEPENSE\",\"LB_DESCRIPTION_DEPENSE\",\"LB_SOUS_CATEGORIE\",\"MT_DEPENSE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?)";
	    ...
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"DT_DEPENSE\" = ?,\"LB_DESCRIPTION_DEPENSE\" = ?,\"LB_SOUS_CATEGORIE\" = ?,\"MT_DEPENSE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"LB_JOB_NAME\" = ? WHERE \"NUM_DEPENSE\" = ?";
...
insertNewcategorieStruct insertNewcategorie_tmp = new insertNewcategorieStruct();
// ###############################
 ...
 */
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"InsertNumLigne");
					}
 ...
 */
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"InsertRejet");
					}
...
// ###############################
// # Outputs initialization
InsertNumLigneStruct InsertNumLigne_tmp = new InsertNumLigneStruct();
InsertRejetStruct InsertRejet_tmp = new InsertRejetStruct();
// ###############################
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"NUM_DEPENSE","DT_DEPENSE","LB_DESCRIPTION_DEPENSE","LB_CATEGORIE","LB_SOUS_CATEGORIE","MT_DEPENSE",});        
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = ((String)globalMap.get("repoFichier")) + "/" + ((String)globalMap.get("nomFichier"));
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(((String)globalMap.get("repoFichier")) + "/" + ((String)globalMap.get("nomFichier")), context.encodage,context.fieldSeparator,"\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
							...
							row1.NUM_DEPENSE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									row1.DT_DEPENSE = ParserUtils.parseTo_Date(temp, "dd/MM/yyyy");
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"DT_DEPENSE", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									row1.DT_DEPENSE = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row1.LB_DESCRIPTION_DEPENSE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 5;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.MT_DEPENSE = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"MT_DEPENSE", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									row1.MT_DEPENSE = null;
...
///////////////////////		
	    		...
	    		if(row1.NUM_DEPENSE != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(row1.NUM_DEPENSE)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.DT_DEPENSE != null) { //              
                 row_tLogRow_1[1]=    						
								FormatterUtils.format_Date(row1.DT_DEPENSE, "dd/MM/yyyy")
					          ;	
							
	    		} //			
    			   				
	    		if(row1.LB_DESCRIPTION_DEPENSE != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row1.LB_DESCRIPTION_DEPENSE)			
					          ;	
	    		...
	    		if(row1.LB_CATEGORIE != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row1.LB_CATEGORIE)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.LB_SOUS_CATEGORIE != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row1.LB_SOUS_CATEGORIE)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.MT_DEPENSE != null) { //              
                 row_tLogRow_1[5]=    						
								FormatterUtils.formatUnwithE(row1.MT_DEPENSE)
					          ;	
...
Var.varNumLigne = Numeric.sequence("s3",1,1) ;// ###############################
        // ###############################
        // # Output tables
...
// # Output table : 'InsertNumLigne'
InsertNumLigne_tmp.NUM_DEPENSE = row2.NUM_DEPENSE ;
InsertNumLigne_tmp.DT_DEPENSE = row2.DT_DEPENSE ;
InsertNumLigne_tmp.LB_DESCRIPTION_DEPENSE = row2.LB_DESCRIPTION_DEPENSE ;
InsertNumLigne_tmp.LB_SOUS_CATEGORIE = row2.LB_SOUS_CATEGORIE ;
InsertNumLigne_tmp.MT_DEPENSE = row2.MT_DEPENSE ;
InsertNumLigne_tmp.NUM_LIGNE = Var.varNumLigne ;
InsertNumLigne = InsertNumLigne_tmp;
// ###### START REJECTS ##### 
// ###############################
 ...
 */
// Start of branch "InsertNumLigne"
if(InsertNumLigne != null) { 
...
row3 = null;			row4 = null;			
if(InsertNumLigne.NUM_DEPENSE == null){
	finder_tUniqRow_1.NUM_DEPENSE = null;
}else{
	finder_tUniqRow_1.NUM_DEPENSE = InsertNumLigne.NUM_DEPENSE.toLowerCase();
}	
...
if(InsertNumLigne.NUM_DEPENSE == null){
	new_tUniqRow_1.NUM_DEPENSE = null;
}else{
	new_tUniqRow_1.NUM_DEPENSE = InsertNumLigne.NUM_DEPENSE.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row4 == null){ 
	
	row4 = new row4Struct();
}row4.NUM_DEPENSE = InsertNumLigne.NUM_DEPENSE;			row4.DT_DEPENSE = InsertNumLigne.DT_DEPENSE;			row4.LB_DESCRIPTION_DEPENSE = InsertNumLigne.LB_DESCRIPTION_DEPENSE;			row4.LB_SOUS_CATEGORIE = InsertNumLigne.LB_SOUS_CATEGORIE;			row4.MT_DEPENSE = InsertNumLigne.MT_DEPENSE;			row4.NUM_LIGNE = InsertNumLigne.NUM_LIGNE;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row3 == null){ 
	
	row3 = new row3Struct();
}				row3.NUM_DEPENSE = InsertNumLigne.NUM_DEPENSE;			row3.DT_DEPENSE = InsertNumLigne.DT_DEPENSE;			row3.LB_DESCRIPTION_DEPENSE = InsertNumLigne.LB_DESCRIPTION_DEPENSE;			row3.LB_SOUS_CATEGORIE = InsertNumLigne.LB_SOUS_CATEGORIE;			row3.MT_DEPENSE = InsertNumLigne.MT_DEPENSE;			row3.NUM_LIGNE = InsertNumLigne.NUM_LIGNE;			
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row5HashKey.NUM_DEPENSE = row4.NUM_DEPENSE ;
								  ...
								  if(!tHash_Lookup_row5.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.NUM_DEPENSE = '" + row5HashKey.NUM_DEPENSE + "'");
								} // G 071
...
insertNewcategorie = null;

if(!rejectedInnerJoin_tMap_2 ) {
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'insertNewcategorie'
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
insertNewcategorie_tmp.NUM_DEPENSE = row4.NUM_DEPENSE ;
insertNewcategorie_tmp.DT_DEPENSE = row4.DT_DEPENSE ;
insertNewcategorie_tmp.LB_DESCRIPTION_DEPENSE = row4.LB_DESCRIPTION_DEPENSE ;
insertNewcategorie_tmp.LB_SOUS_CATEGORIE = row4.LB_SOUS_CATEGORIE ;
insertNewcategorie_tmp.MT_DEPENSE = row4.MT_DEPENSE ;
insertNewcategorie_tmp.LB_NOM_FICHIER = ((String)globalMap.get("nomFichier")) ;
insertNewcategorie_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertNewcategorie_tmp.LB_JOB_NAME = jobName  ;
insertNewcategorie = insertNewcategorie_tmp;
 ...
 */
// Start of branch "insertNewcategorie"
if(insertNewcategorie != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(insertNewcategorie.NUM_DEPENSE == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, insertNewcategorie.NUM_DEPENSE);
}
            ...
            if(checkCount_tDBOutput_3 > 0) {
                        if(insertNewcategorie.DT_DEPENSE != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(1, new java.sql.Timestamp(insertNewcategorie.DT_DEPENSE.getTime()));
} else {
pstmtUpdate_tDBOutput_3.setNull(1, java.sql.Types.TIMESTAMP);
}

                        if(insertNewcategorie.LB_DESCRIPTION_DEPENSE == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(2, insertNewcategorie.LB_DESCRIPTION_DEPENSE);
}

                        if(insertNewcategorie.LB_SOUS_CATEGORIE == null) {
pstmtUpdate_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(3, insertNewcategorie.LB_SOUS_CATEGORIE);
}

                        pstmtUpdate_tDBOutput_3.setFloat(4, insertNewcategorie.MT_DEPENSE);

                        if(insertNewcategorie.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5, insertNewcategorie.LB_NOM_FICHIER);
}

                        if(insertNewcategorie.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(6, new java.sql.Timestamp(insertNewcategorie.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_3.setNull(6, java.sql.Types.TIMESTAMP);
}

                        if(insertNewcategorie.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(7, insertNewcategorie.LB_JOB_NAME);
}

                        if(insertNewcategorie.NUM_DEPENSE == null) {
pstmtUpdate_tDBOutput_3.setNull(8 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(8 + count_tDBOutput_3, insertNewcategorie.NUM_DEPENSE);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, insertNewcategorie.NUM_DEPENSE);
}

                        if(insertNewcategorie.DT_DEPENSE != null) {
pstmtInsert_tDBOutput_3.setTimestamp(2, new java.sql.Timestamp(insertNewcategorie.DT_DEPENSE.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_3.setString(3, insertNewcategorie.LB_DESCRIPTION_DEPENSE);
}

                        if(insertNewcategorie.LB_SOUS_CATEGORIE == null) {
pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(4, insertNewcategorie.LB_SOUS_CATEGORIE);
}

                        pstmtInsert_tDBOutput_3.setFloat(5, insertNewcategorie.MT_DEPENSE);

                        if(insertNewcategorie.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, insertNewcategorie.LB_NOM_FICHIER);
}

                        if(insertNewcategorie.DT_INSERTION != null) {
pstmtInsert_tDBOutput_3.setTimestamp(7, new java.sql.Timestamp(insertNewcategorie.DT_INSERTION.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_3.setString(8, insertNewcategorie.LB_JOB_NAME);
}
...
} // End of branch "insertNewcategorie"
...
insertDuplicate_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("repoFichier"));
insertDuplicate_tmp.LB_NOM_FICHIER = ((String)globalMap.get("nomFichier"));
insertDuplicate_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
insertDuplicate_tmp.LB_LIGNE_REJET = row3.NUM_DEPENSE ;
insertDuplicate_tmp.LB_MESSAGE_REJET = "Données en Double ";
insertDuplicate_tmp.LB_NOM_FLUX = ((String)globalMap.get("nomFlux"));
...
} // End of branch "InsertNumLigne"




// Start of branch "InsertRejet"
if(InsertRejet != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(InsertRejet.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, InsertRejet.LB_CHEMIN_FICHIER);
}

                    if(InsertRejet.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, InsertRejet.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_1.setInt(3, InsertRejet.NUM_LIGNE_REJET);

                    if(InsertRejet.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, InsertRejet.LB_LIGNE_REJET);
}

                    if(InsertRejet.LB_MESSAGE_REJET == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, InsertRejet.LB_MESSAGE_REJET);
}

                    if(InsertRejet.LB_NOM_FLUX == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, InsertRejet.LB_NOM_FLUX);
}

                    if(InsertRejet.DT_REJET != null) {
pstmt_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(InsertRejet.DT_REJET.getTime()));
} else {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(InsertRejet.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, InsertRejet.LB_JOB_NAME);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(((String)globalMap.get("repoFichier")) + "/" + ((String)globalMap.get("nomFichier"))) instanceof java.io.InputStream)){
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"InsertNumLigne");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertNewcategorie");
			  	}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"InsertRejet");
			  	}
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.DT_DEPENSE = readDate(dis,ois);
					
						this.LB_DESCRIPTION_DEPENSE = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.DT_DEPENSE = readDate(dis,objectIn);
					
						this.LB_DESCRIPTION_DEPENSE = readString(dis,objectIn);
					
						this.LB_SOUS_CATEGORIE = readString(dis,objectIn);
					
			            this.MT_DEPENSE = objectIn.readFloat();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeDate(this.DT_DEPENSE, dos, oos);
					
						writeString(this.LB_DESCRIPTION_DEPENSE, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeDate(this.DT_DEPENSE, dos, objectOut);
					
						writeString(this.LB_DESCRIPTION_DEPENSE, dos, objectOut);
					
						writeString(this.LB_SOUS_CATEGORIE, dos, objectOut);
					
					objectOut.writeFloat(this.MT_DEPENSE);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// source node:tDBInput_1 - inputs:(after_tFileInputDelimited_1) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
			   		// linked node: tMap_2 - inputs:(row4,row5) outputs:(insertNewcategorie)
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  \""+context.schema_ods+"\".\"ODS_DEPENSE\".\"NUM_DEPENSE\", \n  \""+context.schema_ods+"\".\"ODS_DEPENSE\".\"DT_DEPENSE\", \n  \""+context.schema_ods+"\".\"ODS_DEPENSE\".\"LB_DESCRIPTION_DEPENSE\", \n  \""+context.schema_ods+"\".\"ODS_DEPENSE\".\"LB_SOUS_CATEGORIE\", \n  \""+context.schema_ods+"\".\"ODS_DEPENSE\".\"MT_DEPENSE\", \n  \""+context.schema_ods+"\".\"ODS_DEPENSE\".\"LB_NOM_FICHIER\", \n  \""+context.schema_ods+"\".\"ODS_DEPENSE\".\"DT_INSERTION\", \n  \""+context.schema_ods+"\".\"ODS_DEPENSE\".\"LB_JOB_NAME\"\nFROM \""+context.schema_ods+"\".\"ODS_DEPENSE\"";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row5.NUM_DEPENSE = null;
							} else {
	                         		
        	row5.NUM_DEPENSE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row5.DT_DEPENSE = null;
							} else {
										
			row5.DT_DEPENSE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 2);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row5.LB_DESCRIPTION_DEPENSE = null;
							} else {
	                         		
        	row5.LB_DESCRIPTION_DEPENSE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row5.LB_SOUS_CATEGORIE = null;
							} else {
	                         		
        	row5.LB_SOUS_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row5.MT_DEPENSE = 0;
							} else {
		                          
            row5.MT_DEPENSE = rs_tDBInput_1.getFloat(5);
        	...
        	row5.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row5.DT_INSERTION = null;
							} else {
										
			row5.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 7);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row5.LB_JOB_NAME = null;
							} else {
	                         		
        	row5.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
				...
				row5_HashRow.NUM_DEPENSE = row5.NUM_DEPENSE;
				
				row5_HashRow.DT_DEPENSE = row5.DT_DEPENSE;
				
				row5_HashRow.LB_DESCRIPTION_DEPENSE = row5.LB_DESCRIPTION_DEPENSE;
				
				row5_HashRow.LB_SOUS_CATEGORIE = row5.LB_SOUS_CATEGORIE;
				
				row5_HashRow.MT_DEPENSE = row5.MT_DEPENSE;
 ...
 */
    ...
    public static void main(String[] args){
        final jODSDepensee jODSDepenseeClass = new jODSDepensee();

        int exitCode = jODSDepenseeClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jODSDepensee.class.getClassLoader().getResourceAsStream("idepense_reporting/jodsdepensee_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jODSDepensee.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("aditionnalParam", "id_String");
                        if(context.getStringValue("aditionnalParam") == null) {
                            context.aditionnalParam = null;
                        } else {
                            context.aditionnalParam=(String) context.getProperty("aditionnalParam");
                        }
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("aditionnalParam")) {
                context.aditionnalParam = (String) parentContextMap.get("aditionnalParam");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jODSDepensee");
        }
...
/************************************************************************************************
 *     257950 characters generated by Talend Open Studio for Data Integration 
 *     on the 18 octobre 2024 à 20:24:58 CEST
 ************************************************************************************************/